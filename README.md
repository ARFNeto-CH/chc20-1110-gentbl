...
Gera uma simples tabela com 256 bytes, para ser incluida em outros programas como criptografia ou conversão
...
O arquivo é gerado em disco ou mostrado na saída padrão. É usado para criar headers para programas de conversão
